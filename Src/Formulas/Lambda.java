...
class Lambda extends Formula{
	...
	@Override
	public void Evolve(){
		double tR1=1-cos(theta)*zr[Niters]+sin(theta)*zi[Niters];
		double tI1=-cos(theta)*zi[Niters]-sin(theta)*zr[Niters];
		double tR=zr[Niters]*tR1-zi[Niters]*tI1;
		double tI=zi[Niters]*tR1+zr[Niters]*tI1;
		zr[Niters+1]=X*tR-Y*tI;
		zi[Niters+1]=sig*(X*tI+Y*tR);
		sig*=falt;    
        Niters++;		
	}
