...
class InvMandelbrot extends Formula{
	double px,py;
	double winv;
	double X,Y;
	double bailout;
	
	public InvMandelbrot(){
		NPars=3;
	}
...
class InvJulia extends Formula{
	double px,py;
	double X,Y;
	double winv;
	double bailout;
...
class InvGeneral_Mandelbrot extends Formula{
	double px,py;
	double X,Y;
	double []cr;
	double []ci;
...
class InvGeneral_Julia extends Formula{
	double px,py;
	double X,Y;
	double []cr;
	double []ci;
...
class InvGeneral_LPMJ extends Formula{
	double []pr;
	double []pi;
	double X,Y;
	double []cr;
